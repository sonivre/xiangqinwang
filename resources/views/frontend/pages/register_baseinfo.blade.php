...
//         * ajax得到某年某月的具体天数
//         */
//        var birthYearSelect = $('input[name=birthYear]');
//        var birthMonthSelect = $('input[name=birthMonth]');
//
//        birthYearSelect.on('change', function () {
//            console.log('aaa');
//            if (birthMonthSelect.val() != '') {
//                refreshCorrentDays($(this).val(), birthMonthSelect.val());
//            }
//        });
//
//        birthMonthSelect.on('change', function () {
//            if (birthYearSelect.val() != '') {
//                refreshCorrentDays($(this).val(), birthYearSelect.val());
//            }
//        });
        $(function () {
            var validation = {};
